...
window._workshopConfig = {
  cognito: {
    userPoolId: 'us-west-2_T3xI4W2SM', // e.g. us-west-2_uXboG5pAb
    userPoolClientId: '60pqeuq8bvshqai48hnd3nqpsa', // e.g. 25ddkmj4v6hfsfvruhpfi7n4hv
    region: 'us-west-2'
  },
  api: {
    invokeUrl: 'https://kpiowai3jc.execute-api.us-west-2.amazonaws.com/dev' // e.g. https://abc123def.execute-api.us-west-2.amazonaws.com/prod
  }
};
